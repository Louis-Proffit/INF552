const _files = {
    map: {
        region: "../data/maps_france_v2/regions-version-simplifiee.geojson",
        departement: "../data/maps_france_v2/departements-version-simplifiee.geojson",
        circonscription: "../data/maps_france_v2/circonscriptions.geojson",
        canton: "../data/maps_france_v2/cantons-version-simplifiee.geojson",
        metropole: "../data/maps_france_v2/metropole-version-simplifiee.geojson"
    },
    data_1: {
        region: "../data/pipeline/region/regions_1.output.csv",
        departement: "../data/pipeline/departement/departements_1.output.csv",
        circonscription: "../data/pipeline/circonscription/circonscriptions_1.output.csv",
        canton: "../data/pipeline/canton/cantons_1.output.csv"
    },
    data_2: {
        region: "../data/pipeline/region/regions_2.output.csv",
        departement: "../data/pipeline/departement/departements_2.output.csv",
        circonscription: "../data/pipeline/circonscription/circonscriptions_2.output.csv",
        canton: "../data/pipeline/canton/cantons_2.output.csv"
    },
};
...
var candidates = {
    DP: { color: "#9B2405", label: "Dupont-Aignan" },
    LP: { color: "#110C4B", label: "Le Pen" },
    MA: { color: "#CC3C7B", label: "Macron" },
    HA: { color: "#E60103", label: "Hamon" },
    AR: { color: "#D4600A", label: "Arthaud" },
    PO: { color: "#81306A", label: "Poutou" },
    CH: { color: "#245D57", label: "Cheminade" },
    LA: { color: "#02958D", label: "Lassale" },
    ME: { color: "#E56231", label: "Mélenchon" },
    AS: { color: "#2C7B95", label: "Asselineau" },
    FI: { color: "#143D98", label: "Fillon" },
...
var getMapColorFunction = function() {
    ...
    if (_state.state.name == "global") {
        ...
        return (area) =>
            colorScale(+area.properties[_state.state.candidates[1] + "_p" + suffix] -
                area.properties[_state.state.candidates[0] + "_p" + suffix]
            );
    }
